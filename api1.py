...
#curl -X POST http://127.0.0.1:5000/upload/notes -F "file=@/Users/akashadhyapak/Downloads/Team Rocket masterplan.pdf"
#curl -X POST http://127.0.0.1:5000/upload/question-bank -F "file=@/Users/akashadhyapak/Downloads/QB.pdf"
#curl -X GET http://127.0.0.1:5000/generate/answers
